            ...
            {/* créer une categorie par role */}
                {['admin', 'webmaster', 'auteur'].includes(auth.user?.role) ? (
                    <div className="mt-1 max-w-50">
                        <Link href="/create/categorie" className="text-orange-300 hover:text-white transition cursor-pointer flex gap-2 items-center">
                        ...
                        categories.map((categorie) => (
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <Link className="" title="Edit" href={`edit/categorie/${categorie.id}`}>
